...
def read_transcript (fn = '/Users/cem_ataman/PycharmProjects/Interview_Analysis/data/All_answers.docx'):
...
def make_lower (data):
    ...
    for i in range(len(data)):
        clean_text_1.append(str(data[i]).lower())
    return (clean_text_1)
...
def remove_stopword (list_stops):
    ...
    stop_words.extend(['2','3','ti','it','1','due','behind','vice','versa',
                       ...
                       'cpf', 'would', 'http', 'mani', 'yeah', 'get' , 'like',
                       'always' , 'thing', 'blah' , 'dipas', 'something', 'really',
                       'okay'])
...
clean_text_9 = remove_less_frequent_words(clean_text_7, 5)

# CREATE BIGRAMS AND TRIGRAMS ----------------------------------------
bigram = Phrases(clean_text_9, min_count=5, threshold=50)
trigram = Phrases(bigram[clean_text_9],min_count=5, threshold=50)
...
with open('/Users/cem_ataman/PycharmProjects/Interview_Analysis/data/intermediate_data/corpus.pkl', 'wb') as f:
    pickle.dump(corpus, f)

x = open("/Users/cem_ataman/PycharmProjects/Interview_Analysis/data/intermediate_data/final_data.py", "w+")
x.write(str(final_data))
x.close()

num_sentences = len(clean_text_2)
print("Number of sentences in the corpus:", num_sentences)

# Flatten the list of lists into a single list
all_words = [word for sentence in clean_text_11 for word in sentence]

# Count the total number of words
num_words = len(all_words)
print("Number of words in the corpus:", num_words)
